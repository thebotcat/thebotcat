  ...
  },
  {
    ...
    execute(o, msg, rawArgs) {
      ...
      if (joinperms && manageperms) {
        ...
        return common.regCmdResp(o, `Set self mute to ${guilddata.voice.connection.voice.selfMute ? 'enabled' : 'disabled'}`);
      } else {
  ...
  },
  {
    ...
    execute(o, msg, rawArgs) {
      ...
      if (joinperms && manageperms) {
        ...
        return common.regCmdResp(o, `Set self deaf to ${guilddata.voice.connection.voice.selfDeaf ? 'enabled' : 'disabled'}`);
      } else {
